...
def _create_site(user = OPENSTACK_USER,
                 password = OPENSTACK_PASSWORD,
                 tenant = OPENSTACK_TENANT_NAME,
                 auth_url = OPENSTACK_AUTH_URL):
    return SiteTest(user, password, tenant, auth_url)


def _create_client(user = OPENSTACK_USER,
                   password = OPENSTACK_PASSWORD,
                   tenant = OPENSTACK_TENANT_NAME,
                   auth_url = OPENSTACK_AUTH_URL,
                   service_type = OPENSTACK_SERVICE_TYPE):
    return tacker.construct_http_client(_create_site(user=user,
                                                     password=password,
                                                     tenant=tenant,
                                                     auth_url=auth_url),
